# terraform-provider-environment-v1alpha1

terraform-provider-environment-v1alpha1 is a terraform provider plugin for the `environment` resource in Nokia EDA.
