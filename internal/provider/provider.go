...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-environment/internal/eda/utils"
...
var _ provider.Provider = (*environmentProvider)(nil)

func New(ver string) func() provider.Provider {
	return func() provider.Provider {
		return &environmentProvider{version: ver}
	}
}
...
func (p *environmentProvider) Metadata(ctx context.Context, req provider.MetadataRequest, resp *provider.MetadataResponse) {
	resp.TypeName = "environment-v1alpha1"
	resp.Version = p.version
}

func (p *environmentProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		NewCliPluginDataSource,
		NewCliPluginListDataSource,
		NewSetupEnvDataSource,
		NewSetupEnvListDataSource,
