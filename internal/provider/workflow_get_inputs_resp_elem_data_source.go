...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-environment/internal/datasource_workflow_get_inputs_resp_elem"
...
const read_ds_workflowGetInputsRespElem = "/workflows/v1/environment.eda.nokia.com/v1alpha1/namespaces/{namespace}/cliplugins/{name}/_input"
