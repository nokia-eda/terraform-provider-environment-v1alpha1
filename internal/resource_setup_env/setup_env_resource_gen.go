...
func SetupEnvResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^SetupEnv$"), ""),
				},
				Default: stringdefault.StaticString("SetupEnv"),
			},
			...
			"name": schema.StringAttribute{
				...
				MarkdownDescription: "name of the SetupEnv",
			},
			"namespace": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
			...
			"spec": schema.SingleNestedAttribute{
				Attributes: map[string]schema.Attribute{
					"env": schema.StringAttribute{
						...
						MarkdownDescription: "Content of the environment file to push.",
					},
				},
				CustomType: SpecType{
					ObjectType: types.ObjectType{
				...
				MarkdownDescription: "This workflow is used to set up the global environment on a node.\nFor SR Linux this results in an overwrite of the /etc/opt/srlinux/env file.",
			},
			"status": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "SetupEnvStatus defines the observed state of SetupEnv",
			},
		},
	}
}

type SetupEnvModel struct {
