...
func CliPluginResourceSchema(ctx context.Context) schema.Schema {
		...
		Attributes: map[string]schema.Attribute{
			...
			"api_version": schema.StringAttribute{
				...
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^environment\\.eda\\.nokia\\.com/v1alpha1$"), ""),
				},
				Default: stringdefault.StaticString("environment.eda.nokia.com/v1alpha1"),
			},
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^CliPlugin$"), ""),
				},
				Default: stringdefault.StaticString("CliPlugin"),
			},
			...
			"name": schema.StringAttribute{
				...
				MarkdownDescription: "name of the CliPlugin",
			},
			"namespace": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
			...
			"spec": schema.SingleNestedAttribute{
				Attributes: map[string]schema.Attribute{
					"content": schema.StringAttribute{
						...
						MarkdownDescription: "Content of the plugin to push.",
					},
					"file_name": schema.StringAttribute{
						Optional:            true,
						Description:         "Name of the plugin to push. For SR Linux this should include the .py extension, without leading slashes.\ne.g. \"myplugin.py\".",
						MarkdownDescription: "Name of the plugin to push. For SR Linux this should include the .py extension, without leading slashes.\ne.g. \"myplugin.py\".",
					},
				},
				CustomType: SpecType{
					ObjectType: types.ObjectType{
				...
				MarkdownDescription: "This workflow is used to push a CLI plugin to a node.",
			},
			"status": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "CliPluginStatus defines the observed state of CliPlugin",
			},
		},
	}
}

type CliPluginModel struct {
